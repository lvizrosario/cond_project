...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn('font-display font-semibold text-lg text-[var(--color-text-primary)]', className)} {...props} />
))
